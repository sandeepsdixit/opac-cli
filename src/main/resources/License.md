...
Ohioedge Software License Agreement, 
version 0.9, March 2018

This is a legal agreement ("this Agreement") between Dixit Ltd. ("Ohioedge") and the 
licensee ("the Licensee"). This Agreement is governed by the laws of the United States of
America.

Ohioedge licenses the Ohioedge software ("the Software") only if all the following
terms are accepted by the Licensee.  The Software includes the Ohioedge bytecode
...
If this Agreement is unacceptable to the Licensee, the Licensee must destroy any copies of 
the Software in the Licensee's possession immediately.

1. LICENSE CONDITIONS

The Licensee is granted a non-exclusive and non-transferable license to install the 
Software. Any copies of the Software should be complete copies including any copyright 
notices.
...
The Licensee acknowledges that Software furnished here under is under test and may be
defective. 

No claims whatsoever can be made on Ohioedge based on any expectation about the Software.
...
Ohioedge is not required to provide maintenance or support to the Licensee.

5. LIMITATION OF LIABILITY

In no event will Ohioedge be liable for any damages, including but not limited to any loss
...
The Software is not available to those not permitted by laws to have access to the 
Software.

8. INSERTION OF MARKER

The Software may insert markers into output files to identify that the files have been 
generated by the Software. Ohioedge bears no responsibility for any damages arising.